...
- [ ] Problem 2 ??
- [x] Problem 7 (@Christine mostly).  I (RCA) *think* you were missing a sum in this answer, so I added it in.  Can you check the change and make sure the logic there still makes sense to you? ---- Looks good to me! thanks
...
Looks correct to me (CT), but you're right that it seems a bit simple
- [ ] Problem 15
- [ ] Problem 16
